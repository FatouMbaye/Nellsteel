...
import { Container, Header, Content, ListItem,CardItem, Label,fixedLabel,Input, CheckBox, Body,Button,Left, Right,Accordionm } from 'native-base';
import Icon from '@expo/vector-icons/AntDesign';

export default class Affiche1 extends React.Component{
